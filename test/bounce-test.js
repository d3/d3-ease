...
it("easeBounce is an alias for easeBounceOut", () => {
  assert.equal(d3.easeBounce, d3.easeBounceOut);
});

it("easeBounceIn(t) returns the expected results", () => {
  assert.equal(d3.easeBounceIn(0.0), 0.000000);
  ...
  assert.equal(d3.easeBounceIn(1.0), 1.000000);
});
...
it("easeBounceOut(t) returns the expected results", () => {
  ...
  assert.equal(d3.easeBounceOut(0.0), bounceOut(0.0));
  ...
  assert.equal(d3.easeBounceOut(1.0), bounceOut(1.0));
});
...
it("easeBounceInOut(t) returns the expected results", () => {
  ...
  assert.equal(d3.easeBounceInOut(0.0), bounceInOut(0.0));
  ...
  assert.equal(d3.easeBounceInOut(1.0), bounceInOut(1.0));
});
