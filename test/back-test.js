...
it("easeBack is an alias for easeBackInOut", () => {
  assert.strictEqual(d3.easeBack, d3.easeBackInOut);
});

it("easeBackIn(t) returns the expected results", () => {
  assert.strictEqual(Math.abs(d3.easeBackIn(0.0)),  0.000000);
  ...
  assert.strictEqual(d3.easeBackIn(1.0), +1.000000);
});
...
it("easeBackOut(t) returns the expected results", () => {
  ...
  assert.strictEqual(d3.easeBackOut(0.0), backOut(0.0));
  ...
  assert.strictEqual(d3.easeBackOut(1.0), backOut(1.0));
});
...
it("easeBackInOut(t) returns the expected results", () => {
  ...
  assert.strictEqual(d3.easeBackInOut(0.0), backInOut(0.0));
  ...
  assert.strictEqual(d3.easeBackInOut(1.0), backInOut(1.0));
});
