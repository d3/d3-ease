...
it("easePoly is an alias for easePolyInOut", () => {
  assert.strictEqual(d3.easePoly, d3.easePolyInOut);
});

it("easePolyIn(t) returns the expected results", () => {
  assert.strictEqual(d3.easePolyIn(0.0), 0.000);
  ...
  assert.strictEqual(d3.easePolyIn(1.0), 1.000);
});
...
it("easePolyIn(t) is the same as polyIn.exponent(3)(t)", () => {
  assert.strictEqual(d3.easePolyIn(0.1), d3.easePolyIn.exponent(3)(0.1));
  assert.strictEqual(d3.easePolyIn(0.2), d3.easePolyIn.exponent(3)(0.2));
  assert.strictEqual(d3.easePolyIn(0.3), d3.easePolyIn.exponent(3)(0.3));
});

it("easePolyIn.exponent(e)(t) coerces t and e to numbers", () => {
  assert.strictEqual(d3.easePolyIn.exponent("1.3")(".9"), d3.easePolyIn.exponent(1.3)(0.9));
  assert.strictEqual(d3.easePolyIn.exponent({valueOf: function() { return 1.3; }})({valueOf: function() { return 0.9; }}), d3.easePolyIn.exponent(1.3)(0.9));
});

it("easePolyIn.exponent(2.5)(t) returns the expected results", () => {
  assert.strictEqual(d3.easePolyIn.exponent(2.5)(0.0), 0.000000);
  ...
  assert.strictEqual(d3.easePolyIn.exponent(2.5)(1.0), 1.000000);
});

it("easePolyOut.exponent(e)(t) coerces t and e to numbers", () => {
  assert.strictEqual(d3.easePolyOut.exponent("1.3")(".9"), d3.easePolyOut.exponent(1.3)(0.9));
  assert.strictEqual(d3.easePolyOut.exponent({valueOf: function() { return 1.3; }})({valueOf: function() { return 0.9; }}), d3.easePolyOut.exponent(1.3)(0.9));
});

it("easePolyOut(t) is the same as polyOut.exponent(3)(t)", () => {
  assert.strictEqual(d3.easePolyOut(0.1), d3.easePolyOut.exponent(3)(0.1));
  assert.strictEqual(d3.easePolyOut(0.2), d3.easePolyOut.exponent(3)(0.2));
  assert.strictEqual(d3.easePolyOut(0.3), d3.easePolyOut.exponent(3)(0.3));
});

it("easePolyOut(t, null) is the same as polyOut.exponent(3)(t)", () => {
  assert.strictEqual(d3.easePolyOut(0.1, null), d3.easePolyOut.exponent(3)(0.1));
  assert.strictEqual(d3.easePolyOut(0.2, null), d3.easePolyOut.exponent(3)(0.2));
  assert.strictEqual(d3.easePolyOut(0.3, null), d3.easePolyOut.exponent(3)(0.3));
});

it("easePolyOut(t, undefined) is the same as polyOut.exponent(3)(t)", () => {
  assert.strictEqual(d3.easePolyOut(0.1, undefined), d3.easePolyOut.exponent(3)(0.1));
  assert.strictEqual(d3.easePolyOut(0.2, undefined), d3.easePolyOut.exponent(3)(0.2));
  assert.strictEqual(d3.easePolyOut(0.3, undefined), d3.easePolyOut.exponent(3)(0.3));
});

it("easePolyOut.exponent(2.5)(t) returns the expected results", () => {
  var polyOut = generic.out(d3.easePolyIn.exponent(2.5));
  assert.strictEqual(d3.easePolyOut.exponent(2.5)(0.0), polyOut(0.0));
  ...
  assert.strictEqual(d3.easePolyOut.exponent(2.5)(1.0), polyOut(1.0));
});

it("easePolyInOut.exponent(e)(t) coerces t and e to numbers", () => {
  assert.strictEqual(d3.easePolyInOut.exponent("1.3")(".9"), d3.easePolyInOut.exponent(1.3)(0.9));
  assert.strictEqual(d3.easePolyInOut.exponent({valueOf: function() { return 1.3; }})({valueOf: function() { return 0.9; }}), d3.easePolyInOut.exponent(1.3)(0.9));
});

it("easePolyInOut(t) is the same as polyInOut.exponent(3)(t)", () => {
  assert.strictEqual(d3.easePolyInOut(0.1), d3.easePolyInOut.exponent(3)(0.1));
  assert.strictEqual(d3.easePolyInOut(0.2), d3.easePolyInOut.exponent(3)(0.2));
  assert.strictEqual(d3.easePolyInOut(0.3), d3.easePolyInOut.exponent(3)(0.3));
});
