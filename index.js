import {linearIn, linearOut, linearInOut} from "./src/linear";
import {quadIn, quadOut, quadInOut} from "./src/quad";
import {cubicIn, cubicOut, cubicInOut} from "./src/cubic";
import {polyIn, polyOut, polyInOut} from "./src/poly";
import {sinIn, sinOut, sinInOut} from "./src/sin";
import {expIn, expOut, expInOut} from "./src/exp";
import {circleIn, circleOut, circleInOut} from "./src/circle";
import {bounceIn, bounceOut, bounceInOut} from "./src/bounce";
import {backIn, backOut, backInOut} from "./src/back";
import {elasticIn, elasticOut, elasticInOut} from "./src/elastic";
